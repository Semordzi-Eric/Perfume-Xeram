    ...
    <div class="bg-obsidian pb-24 px-6 reveal-on-scroll">
      <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-px bg-gold/10">
        ...
        >
          ...
          <!-- Image -->
          <div class="relative overflow-hidden mb-8 delivery-image-frame" style="aspect-ratio: 4/5;">
            <img
              :src="feature.image"
            ...
            />
            <!-- Cinematic gradient -->
            <div class="absolute inset-0 bg-gradient-to-t from-obsidian/85 via-obsidian/25 to-transparent" />
            <!-- Gold radial glow on hover -->
            <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"
                 style="background: radial-gradient(ellipse at center, rgba(201,168,76,0.18) 0%, transparent 60%);" />
            <!-- Hairline border that brightens on hover -->
            <div class="absolute inset-2 border border-gold/0 group-hover:border-gold/30 transition-all duration-700 pointer-events-none" />
          </div>
...
const deliveryFeatures = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=1280&q=85',
    srcSet: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=640&q=80 640w,https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=1280&q=85 1280w',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1606293459339-aa5d34a7b0e1?auto=format&fit=crop&w=1280&q=85',
    srcSet: 'https://images.unsplash.com/photo-1606293459339-aa5d34a7b0e1?auto=format&fit=crop&w=640&q=80 640w,https://images.unsplash.com/photo-1606293459339-aa5d34a7b0e1?auto=format&fit=crop&w=1280&q=85 1280w',
    imageAlt: 'Express courier delivering an elegant package',
    icon: '✦',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1549049950-48d5887197a0?auto=format&fit=crop&w=1280&q=85',
    srcSet: 'https://images.unsplash.com/photo-1549049950-48d5887197a0?auto=format&fit=crop&w=640&q=80 640w,https://images.unsplash.com/photo-1549049950-48d5887197a0?auto=format&fit=crop&w=1280&q=85 1280w',
    imageAlt: 'Customer unwrapping luxury fragrance with delight',
    icon: '✦',
  },
]
